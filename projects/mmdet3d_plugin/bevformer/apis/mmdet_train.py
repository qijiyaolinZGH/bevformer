...
def custom_train_detector(model,
    ...
    print(type(data_loaders))#list
    print(len(data_loaders))#1
    print(type(data_loaders[0]))#<class 'torch.utils.data.dataloader.DataLoader'>
    asd
    '''
    ...
    runner.run(data_loaders, cfg.workflow)#在miniconda3/envs/open-mmlab/lib/python3.8/site-packages/mmcv/runner/epoch_based_runner.py中
