...
def main():
    ...
    print(type(datasets[0]))#<class 'projects.mmdet3d_plugin.datasets.CC_dataset.CCDataset'>
    print(datasets[0])#<projects.mmdet3d_plugin.datasets.CC_dataset.CCDataset object at 0x7fead819bbb0>
    asdasdasd
    '''
